...
<?php
  $rid=$_GET['report'];
  $query_report = "SELECT * FROM comment INNER JOIN student ON comment.student_id=student.id WHERE  report_id='$rid'";
  ...
  <p></p>
  <label for='comment' class='col-sm-10'>Comment By: ".$row_report['name']."<span class='col-sm-offset-6'>".$row_report['date']."</span></label>
  <textarea class='form-control' rows='5' id='comment' name='report' readonly>".$row_report['comments']."</textarea>
 </div>
</div>";
		}?>
